...
security set-keychain-settings -t 28800 -l ~/Library/Keychains/login.keychain
...
defaults write NSGlobalDomain AppleHighlightColor -string "0.612533 0.864026 1.000000";ok

running "Set interface style"
defaults write NSGlobalDomain AppleInterfaceStyle -string "Dark";ok
